...
def densenet121(num_classes, **kwargs: Any) -> DenseNet:
    model = DenseNet(num_classes, (6, 12, 24, 16), 64, 32, **kwargs)

    return model


def densenet161(num_classes, **kwargs: Any) -> DenseNet:
    model = DenseNet(num_classes, (6, 12, 36, 24), 96, 48, **kwargs)

    return model


def densenet169(num_classes, **kwargs: Any) -> DenseNet:
    model = DenseNet(num_classes, (6, 12, 32, 32), 64, 32, **kwargs)

    return model


def densenet201(num_classes, **kwargs: Any) -> DenseNet:
    model = DenseNet(num_classes, (6, 12, 48, 32), 64, 32, **kwargs)
