...
from hyp_utils import set_seed, PoisonDataset, make_and_restore_cifar_model, AverageMeter, accuracy_top1, show_image_row, cifar10_class
from hyp_utils import infer_poison_name, infer_exp_name
...
from hyp_utils import RandomTransform
...
if __name__ == '__main__':
    ...
    args.model_path = os.path.join(args.out_dir, 'AT2.0-e10-aResNet18(Clean)1111', 'checkpoint_last.pth')
    ...
    args.poison_path = os.path.join(args.out_dir, 'AT2.0-e10-aResNet18(Clean)1111', args.poison_name + '.poison')
